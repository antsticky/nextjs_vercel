    ...
    <div className={styles.container}>
      ...
      <section className={styles.section}>
        ...
        <p>
          ...
          the years. Every dish here has been <span className={styles.highlight}>tested in our own kitchen</span> —
      ...
      <section className={styles.section}>
        ...
        <p>
          ...
          lightweight <span className={styles.highlight}>FastAPI</span> backend. It’s hosted on{' '}
          <span className={styles.highlight}>Vercel</span> using the free tier — perfect for a hobby
          project like this.
        </p>
        <p>
      ...
      <section className={styles.section}>
        ...
        <p>
          I’m a passionate <span className={styles.highlight}>home cook and a curious developer</span>. This project
          combines both: a love for good food and a desire to learn new
          technologies.
        </p>
        <p>
      ...
      <section className={styles.section}>
        ...
        <ul className={styles.contactList}>
          <li>
            Email: <a target="_blank" href="mailto:antsticky@gmail.com"><span className={styles.highlight}><strong>antsticky@gmail.com</strong></span></a>
          </li>
          <li>
            GitHub: <a target="_blank" href="https://github.com/antsticky?tab=repositories"><span className={styles.highlight}><strong>github.com/antsticky</strong></span></a>
          </li>
